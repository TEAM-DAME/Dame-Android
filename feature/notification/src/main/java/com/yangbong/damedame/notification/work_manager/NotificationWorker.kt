...
import com.yangbong.damedame.notification.NotificationGenerator
...
class NotificationWorker(
    ...
    private val notificationGenerator=NotificationGenerator(applicationContext)
    ...
    override suspend fun doWork(): Result {
        ...
        try {
            ...
            notificationGenerator.displayNotification()
