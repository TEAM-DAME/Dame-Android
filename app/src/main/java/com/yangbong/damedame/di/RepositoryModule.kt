...
import com.yangbong.data.repository.SelectCharacterRepositoryImpl
...
interface RepositoryModule {
    ...
    @Binds
    @Singleton
    fun bindsSelectCharacterRepository(repository: SelectCharacterRepositoryImpl): SelectCharacterRepository
}
